        ...
        ?>
        <form  class="ModifyForm" name="EmpType" action="process.php">
            <table cellpadding="10%">
                ...
                <tr>
                    ...
                    <td >
                        <input class="textfield" type="text" name="Emp_Type"
                ...
                <tr>
                    ...
                    <td >
                        <input class="textfield" type="text" name="Emp_DA" 
                ...
                <tr>
                    ...
                    <td >
                        <input class="textfield" type="text" name="Emp_Rate_Wholes" 
                ...
                <tr>
                    ...
                    <td >
                        <input class="textfield" type="text" name="Emp_Rate_Pieces" 
                ...
                <tr>
                    ...
                    <td>
                        <input class="textfield" type="text" name="Emp_Rate_Day" 
                ...
                <tr>
                    ...
                    <td>
                        <input class="textfield" type="checkbox" name="CalbyDays"  
                ...
                <tr>
                    ...
                    <td>
                        <input class="textfield" type="text" name="minimum_kg" 
                ...
                <tr>
                    ...
                    <td>
                        <input class="textfield" type="text" name="Description" 
