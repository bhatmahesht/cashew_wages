        ...
        // put your code here
        ?>
<form  class="ModifyForm" name="Wages" action="process.php" >
    <table cellpadding="10%">
        ...
        <tr>
            ...
            <td >
                <input class="textfield" type="text" name="StartDate" 
                       disabled="disabled" size="20"
                       value=<?php
                               $dt=new DateTime($WageWeeksObj->getStartDate());
                               print "'".$dt->format("M d, Y")."'"; ?>  /><br>
            </td>
            <td >
                <label class="labelfield">End Date</label>
            </td>
            <td >
                <input class="textfield" type="text" name="EndDate" 
                       disabled="disabled" size="20"
                       value=<?php
        ...
        <tr>
            ...
            <td >
                <input class="textfield" type="text" name="NoOfKgsWhole"
                       size="20"
                       onblur="return validateWholes(this)"
